...
public class WordGeneratorWithFreemarker {
     ...
     * @return 
     */
    public static File createDoc(String templatePath, String templateName, Map<String, Object> dataMap, String outPath) throws Exception{
        logger.debug("WordGeneratorWithFreemarker createDoc()");
        return Freemarker.fprint(templatePath,templateName,dataMap,outPath);
    }
