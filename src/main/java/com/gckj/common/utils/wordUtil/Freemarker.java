...
public class Freemarker {
    ...
    private static Configuration getInstance(String templatePath) throws IOException {
        logger.debug("Freemarker getInstance："+ configuration);
     ...
     */
    public static File fprint(String templatePath, String templateName, Map<String, Object> root, String outPath) {
