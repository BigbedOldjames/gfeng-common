...
/**
 * 扩展spring的BeanUtils，增加对象拷贝属性排除null值的功能(注：String为null不考虑)
 * 
 */
public class MyBeanUtils extends org.springframework.beans.BeanUtils {
	...
	public static void copyAllProperties(Object source, Object target, Class<?> editable, String[] ignoreProperties) throws BeansException {
